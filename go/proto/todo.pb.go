...
type TodoClient interface {
	AddTask(ctx context.Context, in *Task, opts ...grpc.CallOption) (*Tasks, error)
...
func (c *todoClient) AddTask(ctx context.Context, in *Task, opts ...grpc.CallOption) (*Tasks, error) {
	out := new(Tasks)
...
type TodoServer interface {
	AddTask(context.Context, *Task) (*Tasks, error)
...
var fileDescriptor0 = []byte{
	...
	0x23, 0x77, 0xa0, 0x2d, 0x40, 0x87, 0x09, 0x49, 0x71, 0xb1, 0x3b, 0xa6, 0xa4, 0x80, 0x2d, 0x84,
	0x28, 0x90, 0x62, 0x03, 0x53, 0xc5, 0x4a, 0x0c, 0x42, 0xca, 0x5c, 0x9c, 0x20, 0xe7, 0x42, 0x4c,
	0xe3, 0xd1, 0x43, 0x72, 0x3a, 0x42, 0x51, 0x12, 0x1b, 0xd8, 0x6b, 0xc6, 0x80, 0x00, 0x00, 0x00,
	0xff, 0xff, 0xfc, 0xf2, 0x88, 0x91, 0xe8, 0x00, 0x00, 0x00,
}
